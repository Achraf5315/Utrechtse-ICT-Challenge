    ...
    public function run(): void
    {
        ...
        $vacatures = [
            ...
            [
                ...
                'location'    => 'Houten',
                'salary'      => 2400.00,
                'vakgebied'   => 'Beveiliging',
                'opleiding'   => 'VMBO-KB / MBO 2',
            ],
            [
            ...
            [
                ...
                'salary'      => 5100.00,
                'vakgebied'   => 'Analyse & Onderzoek / ICT / Digitale Opsporing',
                'opleiding'   => 'HBO Bachelor',
            ],
            [
                ...
                'location'    => 'Zeist',
                'salary'      => 6100.00,
                'vakgebied'   => 'Facility / ICT / Bedrijfsvoering',
                'opleiding'   => 'HBO Bachelor',
            ],
            [
            ...
            [
                ...
                'location'    => 'Driebergen',
                'salary'      => 2600.00,
                'vakgebied'   => 'Administratie en secretarieel',
                'opleiding'   => 'MBO 3',
            ],
            [
                ...
                'location'    => 'Utrecht',
                'salary'      => 2700.00,
                'vakgebied'   => 'Facility / Bedrijfsvoering',
                'opleiding'   => 'MBO 3',
            ],
            [
            ...
            [
                ...
                'location'    => 'Driebergen-Rijsenburg',
                'salary'      => 5900.00,
                'vakgebied'   => 'ICT / Digitale Opsporing',
                'opleiding'   => 'HBO Bachelor',
            ],
            [
                ...
                'location'    => 'Zeist',
                'salary'      => 3200.00,
                'vakgebied'   => 'Facility / ICT / Techniek',
                'opleiding'   => 'MBO 4',
            ],
            [
            ...
            [
                ...
                'salary'      => 5000.00,
                'vakgebied'   => 'Juridisch / Bedrijfsvoering',
                'opleiding'   => 'HBO Bachelor',
            ],
            [
                ...
                'location'    => 'Woerden',
                'salary'      => 5200.00,
                'vakgebied'   => 'Digitale Opsporing / Opsporing',
                'opleiding'   => 'HBO Bachelor',
            ],
            [
            ...
            [
                ...
                'salary'      => 0.00,
                'vakgebied'   => 'Techniek / Vrijwilligerswerk',
                'opleiding'   => 'HBO Bachelor',
            ],
            [
                'title'       => 'bedrijfsarts',
        ...
        foreach ($vacatures as $v) {
            // Maak eerst een job_detail aan
            $detailId = DB::table('job_details')->insertGetId([
                'description'      => "Wij zoeken een enthousiaste {$v['title']} voor de Nationale Politie. "
                    . "In deze functie werk je binnen het vakgebied {$v['vakgebied']} en draag je bij aan een veilige samenleving. "
                    . "Het vereiste opleidingsniveau is {$v['opleiding']}.",

                'requirements'     => "- Afgerond {$v['opleiding']} diploma\n"
                    . "- Minimaal 2 jaar relevante werkervaring binnen {$v['vakgebied']}\n"
                ...
                'responsibilities' => "- Uitvoeren van werkzaamheden binnen het team {$v['vakgebied']}\n"
